...
import type { ApAgingRow } from "@/lib/hms/vendor-bill-payments";
...
export function AccountsApAgingClient({
  slug,
  rows,
  ...
  return (
    <div className="w-full px-6 py-8 sm:px-8">
      ...
      <p className="mt-0.5 text-sm text-slate-500">
        Every approved, unpaid vendor bill, bucketed by how overdue it is against its due date.
      </p>
        ...
        <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
          <div className="overflow-x-auto">
            <table className="w-full min-w-[760px] text-left text-sm">
              ...
              <tbody>
                {rows.map((r) => (
                  <tr key={r.vendorId} className="border-b border-slate-100 last:border-0 hover:bg-slate-50/80">
